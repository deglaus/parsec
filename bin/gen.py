...
# Created by Peter Yuen (https://github.com/ppeetteerrs) - (2021)
# Modified by Johan Söderström (https://github.com/deglaus) - 2025
...
# dir to build linux
out_dir = os.path.abspath("output_images")

benches="blackscholes bodytrack canneal ferret fluidanimate freqmine streamcluster swaptions".split() # removed dedup, facesim

simsizes="simsmall simmedium simlarge".split()
